...
exp_info = [
    ...
    "Tranlslated interface designs from the design team into React.js assets that were then implemented by the development team and shipped to over 10,000 users.",
...
project_a = {
    ...
    'info': [
        "Implemented 8 compute shaders that create an ocean height map in realtime using the GLSL shading language.",
...
project_b = {
    ...
    'info': [
        "Implemented modern graphics programming techniques to allow for high-performance high-qulaity graphics.",
...
project_c = {
    'name': "Course Preperation Website",
    ...
    'info': [
        "Managed team of 4 developers, planned weekly sprints, and scheduled frequent meetings with client to discuss developments and furutre goals.",
...
coursework = ["                               ","Databases", "Data Sctructures", "Analysis of Algorithms", "Object Oriented Design", "Compute Systems", "Networks", "Formal Languages", " Opereating Systems",
...
skills = [ "C++", "C", "C#", "Javascript", "Java", "Python", "SQL", "Lisp", "CSS", "HTML",
           "HLSL", "GLSL", "React", "Three.js", "Unity", "Blender", "Vulkan", "OpenGL", "WebGL",
